...
ArrMonth <- ggplot(data=ArrDf, aes(x=Month, y=ArrDelay)) +
...
ArrDayOfWeek <- ggplot(data=ArrDf, aes(x=DayOfWeek, y=ArrDelay)) +
  geom_bar(stat="identity", position='dodge', fill="steelblue") +
...
ArrDayOfWeek <- ggplot(data=ArrDf, aes(x=DepTime, y=ArrDelay)) +
